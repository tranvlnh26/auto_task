...
public class Controller : IMessageHandler
{
	...
	public void onMessage(Message msg)
	{
		...
		try
		{
			...
			case -91:
			{
				...
				for (int num38 = 0; num38 < b19; num38++)
				{
					...
					GameCanvas.panel.planetNames[num38] = msg.reader().readUTF();
						...
						TranVinh.Xmap.Pk9rXmap.ShowPanelMapTrans();
				break;
			}
			case -90:
			{
			...
			case -21:
			{
				...
				{
							var it = (ItemMap)GameScr.vItemMap.elementAt(num123);
	...
	public void loadInfoMap(Message msg)
	{
		...
		catch (Exception ex)
		{
			...
			TranVinh.Xmap.Pk9rXmap.FixBlackScreen();
		}
		finally
		{
            Char.isLoadingMap = false;
