...
namespace TranVinh.Xmap
{
    ...
    {
        internal static List<int> FindWay(int idMapStart, int idMapEnd)
        {
        ...
        static List<int> FindWay(int idMapEnd, List<int> wayPassed)
        {
        ...
        static List<int> GetBestWay(List<List<int>> ways)
        {
            if (ways.Count == 0)
                return null;
        ...
        static List<int> GetWayPassedStart(int idMapStart)
        {
        ...
        static List<int> GetWayPassedNext(List<int> wayPassed, int idMapNext)
        {
        ...
        /// <returns></returns>
        static bool IsWayBetter(List<int> way1, List<int> way2)
        {
        ...
        static bool IsBadWay(List<int> way)
        {
            return IsWayGoFutureAndBack(way);
        }

        static List<int> mapsGoFuture = new List<int>() { 27, 28, 29 };
        static bool IsWayGoFutureAndBack(List<int> way)
        {
